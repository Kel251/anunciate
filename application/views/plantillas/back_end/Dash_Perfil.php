                    ...
                    <div class="profile-info">
                        ...
                        <div class="col-xs-8">
                            ...
                            <div class="profile-buttons">
                                ...
                                <a href="<?php echo base_url() ?>Control_Usuario" title="Sign Out"><i class="fa fa-power-off text-red-1"></i></a><!--href="javascript:;"-->
                            </div>
                        </div>
                    </div>
                    <!--- Divider -->
...
<!--                            <li class='has_sub'>
        ...
        <script src="<?php echo base_url() ?>assets/libs/jquery-gmap3/gmap3.min.js"></script>
        <script src="<?php echo base_url() ?>assets/js/pages/google-maps.js"></script>
    </body>
</html>