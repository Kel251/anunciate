            ...
            <div class="col-lg-3 col-md-6">
                <div class="widget green-1 animated fadeInDown">
                    <div class="widget-content padding">
                        ...
                        <?php if(isset($stats)): foreach ($stats as $value): ?>
                        
                        <div class="text-box">
                            <p class="maindata">TOTAL <b>COMENTARIOS</b></p>
                            <h2><span class="animate-number" data-value="<?= $value->Total; ?>" data-duration="3000">0</span></h2>
