<div class="container col-xs-12 col-sm-10 col-lg-10 contenido">      
    <img src="<?php echo base_url() ?>img/headempleos.jpg" style="width: 100%;"> 
</div>
...
<div class="col-xs-12 col-sm-12 col-lg-10 contenido"><div id="listaimg1"></div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">        
        ...
        <div class="slider5 col-xs-12 col-sm-12 col-lg-12">
            <?php if (isset($emplesug)): foreach ($emplesug as $value):
                    ?>
                    <div class="slide">
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <button class="btn btn-xs btn-notify">Recibir notificaciones</button>
        <div class="slider5 col-xs-12 col-sm-12 col-lg-12">
            <?php if (isset($empledest)): foreach ($empledest as $valdes):
                    ?>
                    <div class="slide">
                        <!-- SECCION DE CONTENIDO 1-->
                        <article class="col-xs-12 col-sm-6 col-md-12">
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <button class="btn btn-xs btn-notify">Recibir notificaciones</button>
        <div class="slider5 col-xs-12 col-sm-12 col-lg-12">
            <?php if (isset($emplereci)): foreach ($emplereci as $valre):
                    ?>
                    <div class="slide">
                        <!-- SECCION DE CONTENIDO 1-->
                        <article class="col-xs-12 col-sm-6 col-md-12">
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">        
        ...
        <button class="btn btn-xs btn-notify">Recibir notificaciones</button>
        <div class="slider5 col-xs-12 col-sm-12 col-lg-12">
            <?php if (isset($masemple)): foreach ($masemple as $valve):
                    ?>
                    <div class="slide">
                        <!-- SECCION DE CONTENIDO 1-->
                        <article class="col-xs-12 col-sm-6 col-md-12">
