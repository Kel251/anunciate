        ...
        <div class="container target">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <button type="button" class="btn btn-success">Agrar a favoritos!</button>  <button type="button" class="btn btn-info">Envíar mensaje</button>
                    <br/><br/>
                    <!--left col-->
                    <ul class="list-group">
        ...
        <div class="col-sm-12" contenteditable="false" style="">
            ...
            <div class="panel panel-default">
                <div class="panel-heading claspanelno"><h4>Ubicación en el Mapa</h4></div>
                 <?php if(isset($latitud) and isset($lon)){
