    ...
    <div class="content">
        ...
        <div class="widget">
            ...
            <div class="widget-content padding">
                <form class="form-inline" role="form" action ='<?php echo base_url('Control_Dashuser/cargainformacion') ?>' method='POST'>
        ...
        <div class="widget">
            ...
            <div class="widget-content padding">
                ...
                <!--CONSULTA SIMPLE ENTRE UNA SOLA TABLA-->
...
//        $Id_anun = $object->id_anun;
                        $id_cat = $object->Id_cat;
//        $descripcion = $object->descripcion;
                        $nombre = $object->Nom_cat;
//        $costop = $object->costo;
//        $tipop = $object->tipo;
                        echo "<tr><td>$id_cat</td><td>$nombre</td>
 </tr>";
                    }
                    ?>
                </table>-->
                ...
                <table  class="table table-striped table-bordered table-hover">
                    ...
                    foreach ($resultado as $fila) {
                        ...
                        <tr>
                            <td><?= $fila->Id_cat ?></td>
                            <td><?= $fila->Nom_cat ?></td>
                            <td><?= $fila->Id_subcat ?></td>
                            <td><?= $fila->Nom_subcat ?></td>
                        </tr>
                        <?php
                    }
                    ?>
